            ...
            <form action="/submit" method="post">
                ...
                @if ($errors->any())
                    <div class="alert alert-danger" role="alert">
                        Por favor, arrumar os erros marcados
                    </div>
                @endif
                <div class="form-group">
                    <label for="title">Title</label>
                    <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" placeholder="Titulo" value="{{ old('title') }}">
                    @error('title')
